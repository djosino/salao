...
Gem::Specification.new do |s|
  ...
  s.date = "2012-09-20"
  s.description = "brhelper \u{e9} uma das gems que compoem o Brazilian Rails"
  ...
  s.summary = "brhelper \u{e9} uma das gems que compoem o Brazilian Rails"
