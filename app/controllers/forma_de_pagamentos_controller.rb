  ...
  def create
    ...
    respond_to do |format|
      if @forma_de_pagamento.save
        format.html { redirect_to @forma_de_pagamento, notice: 'Forma de pagamento was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @forma_de_pagamento.update(forma_de_pagamento_params)
        format.html { redirect_to @forma_de_pagamento, notice: 'Forma de pagamento was successfully updated.' }
