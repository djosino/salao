...
class ServicosControllerTest < ActionController::TestCase
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post :create, servico: { descricao: @servico.descricao, percentual: @servico.percentual, valor: @servico.valor }
    end
  ...
  test "should update servico" do
    patch :update, id: @servico, servico: { descricao: @servico.descricao, percentual: @servico.percentual, valor: @servico.valor }
    assert_redirected_to servico_path(assigns(:servico))
  end
